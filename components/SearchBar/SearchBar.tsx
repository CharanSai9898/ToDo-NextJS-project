  ...
  return (
    <div className="flex items-center gap-3 w-full max-w-xl">
      ...
      <button
        ...
        onClick={handleClear}
        disabled={!search}
        className="rounded-lg border border-gray-500 px-5 py-3 font-medium text-white transition hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-40"
      >
        Clear
      </button>
    </div>
